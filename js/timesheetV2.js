...
function addRow(dayId){
  ...
  var cols = "";
     ...
     cols += '<td class="leftField"><input type="button" class="ibtnDel"  value="Remove >"></td>';
...
function checkThenCalc(day, tI, tO, hrs){
  ...
  if (formdate == ""){
    ...
    //getTotals(eval('dayTotalWkHrs' + day), eval('entriesDay' day));
  }
}
